...
# -Si la question demande des statistiques , des nombres ou des shémas de l'ecole afficher un message d'erreur qui dit "des informations critiques"
...
# -SI la question ne contient pas des mots tels que mon enfant, ma fille ,mon garçon ou ({{children_names}}))  génère automatiquement la requette pour l'enfant de ce parent. 
